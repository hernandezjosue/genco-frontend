...
export function WhatWeDo() {
  ...
  return (
    <section
      ...
      ref={ref}
    >
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#ffffff05_1px,transparent_1px),linear-gradient(to_bottom,#ffffff05_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_50%,#000_70%,transparent_110%)]" />
        ...
        >
          ...
          >
            ...
            <div className="text-center space-y-2">
              <div className="text-sm text-slate-600 uppercase tracking-wider">{t('projectsCompleted')}</div>
          ...
          >
            <div className="text-xs font-bold tracking-wider mb-6 uppercase text-slate-400">{t('ourApproach')}</div>
            <motion.div
              whileHover={{ scale: 1.05 }}
            ...
            >
              <div className="w-full h-full bg-gradient-to-br from-primary/20 to-blue-600/20 rounded-2xl flex items-center justify-center">
                <motion.svg
